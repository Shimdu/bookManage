...
public class BookManageInterFrm extends JInternalFrame {
	...
	public BookManageInterFrm() {
		...
		s_bookNameTxt.setFont(new Font("宋体", Font.PLAIN, 12));
		...
		s_bookAuthorTxt.setFont(new Font("宋体", Font.PLAIN, 12));
		...
		s_bookTypeJcb.setFont(new Font("宋体", Font.PLAIN, 12));
		...
		bookTable.setFont(new Font("宋体", Font.PLAIN, 12));
	...
	private void bookDeleteActionPerformed(ActionEvent evt){
		...
		int n = JOptionPane.showConfirmDialog(null, "是否要删除该记录？");
		if(n==0) {
			Connection con = null;
			try {
				con = dbUtil.getCon();
	...
	private void bookUpdateActionPerformed(ActionEvent evt) {
		...
		if(StringUtil.isEmpty(id)) {
			JOptionPane.showMessageDialog(null, "请选择一条需要修改的记录！");
		}
